...
namespace Blackjack
{
    class Program
    {
        ...
        {            
            int cardIndex = random.Next(1, 52);        // card index, a value from 0 to 51 inclusive
        ...
        //    int cardIndex = random.Next(1, 52);        // card index, a value from 0 to 51 inclusive
        //    int suit = cardIndex % 4;
        //    int value = (cardIndex % 12) + 1;         // the value of the card, from 1 to 13
